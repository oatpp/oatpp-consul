...
#include OATPP_CODEGEN_BEGIN(ApiClient)
  ...
  API_CALL(HTTP_PUT, "v1/session/create", sessionCreate, BODY_DTO(Object<SessionPayload>, payload))
  ...
  API_CALL(HTTP_PUT, "v1/agent/service/register", agentServiceRegister, BODY_DTO(Object<AgentServiceRegisterPayload>, payload))
  ...
  API_CALL_ASYNC(HTTP_PUT, "v1/agent/service/register", agentServiceRegisterAsync, BODY_DTO(Object<AgentServiceRegisterPayload>, payload))
